...
public class Utilit‡Test {
	...
	public void testPrintSetVuoto() {
		assertEquals("Vuoto", Utilit‡.printSet(this.setVuoto));
	}
	...
	public void testPrintSetPieno2() {
		assertNotEquals("Vuoto", Utilit‡.printSet(this.setPieno));
	}

	@Test
	public void testPrintListVuota() {
		assertEquals("Vuoto", Utilit‡.printList(this.listVuota));
	}
	...
	public void testPrintListPiena2() {
		assertNotEquals("Vuoto", Utilit‡.printList(this.listPiena));
	}
	
	@Test
	public void testPrintMapVuota() {
		assertEquals("Vuoto", Utilit‡.printMap(this.mapVuota));
	}
	...
	public void testPrintMapPiena2() {
		assertNotEquals("Vuoto", Utilit‡.printMap(this.mapPiena));
	}
